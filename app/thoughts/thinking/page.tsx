    ...
    return (
        <div className="bg-white h-screen flex flex-col items-center justify-center p-4">
            <article className="max-w-prose">
                <p className="text-black text-2xl mb-4">Ramblings</p>
                ...
                <p className="text-black text-sm mb-4">
                    ...
                    <a href="https://en.wikipedia.org/wiki/G%C3%B6del%27s_incompleteness_theorems" style={{ color: 'blue' }}> truths outside the reach of those operating in a formal system.</a> 
