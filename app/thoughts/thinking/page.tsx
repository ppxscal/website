        ...
        <div className="bg-white min-h-screen flex flex-col items-center justify-center p-4 md:p-8">
            <article className="max-w-prose w-full">
                ...
                <p className="text-black text-base md:text-lg mb-4">
                    ...
                    of axioms, we can surpass them. Surpassing them in the sense of understanding their limitations, and what lies beyond. We can understand things about our universe like the limits of logic, general relativity, computability, and the standard model. 
                </p>
